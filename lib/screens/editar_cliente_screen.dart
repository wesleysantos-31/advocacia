...
class _EditarClienteScreenState extends State<EditarClienteScreen> {
  ...
  void initState() {
    ...
    _dataNascCtrl = TextEditingController(text: c.dataNascimento ?? '');
    _nitPisCtrl = TextEditingController(text: c.nitPis ?? '');
    _telefoneCtrl = TextEditingController(text: c.telefone ?? '');
    _emailCtrl = TextEditingController(text: c.email ?? '');
    _enderecoCtrl = TextEditingController(text: c.endereco ?? '');
    _senhaGovCtrl = TextEditingController(text: c.senhaGov ?? '');
    _observacoesCtrl = TextEditingController(text: c.observacoes ?? '');
    _estadoCivil = c.estadoCivil;
  ...
  Future<void> _salvar() async {
    ...
    try {
      ...
      await ClienteService.atualizar(widget.cliente, clienteAtualizado);
